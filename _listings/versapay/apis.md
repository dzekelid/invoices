...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/invoices/master/_listings/versapay/apis.md
...
- name: VersaPay API Reference - Create and Update Invoice
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/invoices/master/_listings/versapay/apiimportsinvoice-post-openapi.md
- name: VersaPay API Reference - Create and Update Invoice
  x-api-slug: apiimportsinvoice-post
  description: |-
    Create and update invoices in ARC. If the invoice already exists when a request is processed, it will be updated.<br><br>
