...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/invoices/master/_listings/eu-vat-api/apis.md
...
- name: VAT API - Create a VAT invoice
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/invoices/master/_listings/eu-vat-api/invoice-post-openapi.md
- name: VAT API - Delete an invoice
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/invoices/master/_listings/eu-vat-api/invoiceid-delete-openapi.md
- name: VAT API - Retrieve an invoice
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/invoices/master/_listings/eu-vat-api/invoiceid-get-openapi.md
- name: VAT API - Update an existing invoice
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/invoices/master/_listings/eu-vat-api/invoiceid-put-openapi.md
- name: VAT API - Create a VAT invoice
  x-api-slug: invoice-post
  description: Create a vat invoice.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/vatapi-logo.png
