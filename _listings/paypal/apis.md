...
- name: PayPal (Sandbox) - Mark Invoice As Paid
  x-api-slug: invoicemarkinvoiceaspaid-post
...
- name: PayPal (Sandbox) - Cancel Invoice
  x-api-slug: invoicecancel-invoice-post
...
- name: PayPal (Sandbox) - Get Invoice Details
  x-api-slug: invoicegetinvoicedetails-post
...
- name: PayPal (Sandbox) - Update Invoice
  x-api-slug: invoiceupdateinvoice-post
...
- name: PayPal (Sandbox) - Create And Send Invoice
  x-api-slug: invoicecreateandsendinvoice-post
...
- name: PayPal (Sandbox) - Send Invoice
  x-api-slug: invoicesendinvoice-post
...
- name: PayPal (Sandbox) - Create Invoice
  x-api-slug: invoicecreateinvoice-post
